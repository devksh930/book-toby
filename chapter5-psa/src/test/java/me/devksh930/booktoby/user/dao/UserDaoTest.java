...
public class UserDaoTest {
    ...
    @BeforeEach
    public void setUp() {
        this.user1 = new User("aaaa", "1번", "springno1", Level.BASIC, 1, 0);
        this.user2 = new User("bbbb", "2번", "springno2", Level.SILVER, 55, 10);
        this.user2 = new User("cccc", "3번", "springno2", Level.SILVER, 55, 10);
    }
